...
bool PlaneChooseLayer::init()
{
	...
	if (UserDefault::getInstance()->getBoolForKey(IS_GET_VIKING, 0) == true && UserDefault::getInstance()->getBoolForKey(IS_GET_VIKING_S, 0) == true)
	{
	...
	else if (UserDefault::getInstance()->getBoolForKey(IS_GET_VIKING, 0) == true && UserDefault::getInstance()->getBoolForKey(IS_GET_VIKING_S, 0) == false)
	{
	...
	else if (UserDefault::getInstance()->getBoolForKey(IS_GET_VIKING, 0) == false && UserDefault::getInstance()->getBoolForKey(IS_GET_VIKING_S, 0) == false)
