...
- (void)adsMoGoInterstitialAdWillPresent{
    if(cocos2d::UserDefault::getInstance()->getBoolForKey("AD_COIN", false) == true)
    {
        int Num = cocos2d::UserDefault::getInstance()->getIntegerForKey(COIN_NUM, 0)+10;
        cocos2d::UserDefault::getInstance()->setIntegerForKey(COIN_NUM, Num);
        cocos2d::UserDefault::getInstance()->setBoolForKey("RingOut",true);
