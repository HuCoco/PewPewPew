...
bool MenuLayer_H::init()
{
	...
	GotoAboutSceneBtn->setPosition(MyWinSize.width - GotoAboutSceneBtn->getContentSize().width / 2, MyWinSize.height - GotoAboutSceneBtn->getContentSize().height / 2);
	...
	cocos2d::Menu* menu = 
		cocos2d::Menu::create(GotoLotterySceneBtn,GotoRankSceneBtn,GoBtn, GotoAboutSceneBtn, GotoOptionSceneBtn, NULL);
...
void MenuLayer_H::GotoChooseLayer(Ref* pSender)
{
	Scene* scene = Scene::create();
	scene->addChild(LotteryChooseLayer::create());
